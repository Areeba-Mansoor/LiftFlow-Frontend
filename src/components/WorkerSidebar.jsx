        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between px-3 pt-2">
            <div>
              ...
              <p className="text-[13px] text-gray-400 mt-0.5">Worker Portal</p>
            </div>
            <button
              onClick={onClose}
          ...
          <nav className="space-y-1 text-xs font-medium text-gray-600">
            <a href="#" onClick={onClose} className="flex items-center gap-3 px-3.5 py-2.5 bg-amber-50 text-amber-700 rounded-xl font-semibold">
              <LayoutDashboard size={18} className="text-amber-600" />
              Dashboard
            </a>
            <a href="#" onClick={onClose} className="flex items-center gap-3 px-3.5 py-2.5 hover:bg-gray-50 rounded-xl transition-colors">
        ...
        <div className="space-y-4 pt-4 border-t border-gray-100">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="overflow-hidden">
              <h4 className="text-xs font-bold text-gray-800 truncate">{user?.name || 'Worker'}</h4>
